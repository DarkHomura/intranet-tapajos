...
import {
    ...
    fetchNegotiationCampaignsByStatus,
...
import { fetchCampaignByStatus } from '@/hooks/slices/trade/tradeSlice';
...
export function TableTradeNegotiations() {
    ...
    const [statusNegotiation, setStatusNegotiation] = useState(false)
    ...
    function handleGetDisableNegotiations() {
        dispatch(fetchNegotiationCampaignsByStatus(statusNegotiation))
        setStatusNegotiation(!statusNegotiation)
    }
            ...
            >
                ...
                <Form.Item className="mb-2 md:mb-0">
                    <Space>
                        ...
                        <Button onClick={handleGetDisableNegotiations}>Exibir {statusNegotiation ? "ativos" : "inativos"}</Button>
                    </Space>
                </Form.Item>
            </Form>
