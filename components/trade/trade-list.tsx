...
export function TableTrade() {
                    ...
                    <div>
                        <div className="mb-4">
                            ...
                            <p>
                                ...
                                {/*currentCampaign?.campanha?.valor_total*/ "R$ " +
                                        ...
                                        >
                                            ...
                                            {participante.meta === 'VALOR' && (
                                                <p>
                                                    ...
                                                    {"R$ " + participante.meta_valor}
                                                </p>
                                            )}
                                            <p>
                                                <strong>Premiação:</strong>{' '}
                                                {"R$ " + participante.premiacao}
                                            </p>
                                        </div>
                                    )
                                )}
    ...
    function handleDisableCampaigns (){
        dispatch(fetchCampaignByStatus(statusNegotiation))
            ...
            >
                ...
                <Form.Item className="mb-2 md:mb-0">
                    <Space>
                        ...
                        <Button onClick={handleDisableCampaigns}>Exibir  {statusNegotiation? "ativos":"inativos" }</Button>
                    </Space>
                </Form.Item>
            </Form>
